...
export default function Hero(){
    return(
        <div className="flex flex-col lg:flex-row gap-[100px] px-4 sm:px-20 py-4">{/*hero section */}
        <div className="w-full lg:w-1/2 bg-white">{/*left div */}
          <h1 className="font-bold text-3xl sm:text-6xl tracking-wider pb-6">Stay ahead of the curve with our forward-thinking</h1>
        ...
        <div className="flex gap-4 bg-white w-full lg:w-1/2 flex-col sm:flex-row">{/*right */}
          ...
          <div className="w-full sm:w-1/2 bg-white hidden sm:flex relative overflow-hidden rounded-tl-full rounded-tr-lg">
           
            <Image src="/image1.jpg" alt="image goes here" layout="fill" className="rounded object-cover" />
