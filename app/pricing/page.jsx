            ...
            <div className="rounded-lg bg-slate-800 p-8" >
                ...
                <div className="flex justify-center flex-wrap gap-4 sm:gap-0">

                    {
                        packs.map((pack)=>{
                            return(
                                <div key={pack.id} className={` ${pack.title===popular?"bg-slate-700 flex justify-center flex-col text-white border border-slate-700 rounded-lg p-10  shadow-lg shadow-slate-500 relative":"relative shadow-lg shadow-slate-500 flex justify-center flex-col text-white border border-slate-700 rounded-lg p-6"} `}>
